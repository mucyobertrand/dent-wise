...
const DoctorsManagement = () => {
    ...
    const [ selectedDoctor, setSelectDoctor] = useState<Doctor | null>(null);
                ...
                {doctors.map(doctor =>(
                    ...
                    >
                        <div className='flex items-center gap-4'>
                            <Image src={doctor.imageUrl} alt={doctor.name} width={48} height={48} className='size-12 rounded-full object-cover ring-2 ring-background' unoptimized={true}/>
