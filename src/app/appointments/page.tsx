              ...
              <div key={appointment.id} className="bg-card border rounded-lg p-4 shadow-sm">
                ...
                <div className="space-y-1 text-sm">
                  <div className=" flex items-center gap-4 text-muted-foreground">
                    <CalendarIcon className="size-4 text-primary"/> {format(new Date(appointment.date), "MMM d, yyyy")}
                  </div>
                  <div className="flex items-center gap-4 text-muted-foreground"><ClockIcon className="size-4 text-primary"/> {appointment.time}</div>
                </div>
              </div>
            ))}
          </div>
